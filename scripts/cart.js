...
//add items to cart after clicking the add to cart icon
...
(function (){
    ...
    cartBtn.forEach(function(btn){
        btn.addEventListener("click", function(event){
            ...
            const item = {};
//show image in cart when selected
            item.img =`media ${partPath}`;
...
//Total price increases as items are added to the cart
